...
### Features
 ...
 - Added `FillLayer.getFillSortKey` and `LineLayer.getLineSortKey` methods to get the sort key of a layer.  Added `PropertyFactory.fillSortKey` and `PropertyFactory.lineSortKey` to set the sort key of a layer. Features with a higher sort key will appear above features with a lower sort key. ([#209](https://github.com/mapbox/mapbox-gl-native-android/pull/209))
