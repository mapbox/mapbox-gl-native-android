...
/**
 * Basic smoke tests for LocationComponentLayer
 */
@RunWith(AndroidJUnit4.class)
public class LocationComponentLayerTest extends BaseLayerTest {

  private LocationComponentLayer layer;

  @Before
  @UiThreadTest
  public void beforeTest(){
    super.before();
    layer = new LocationComponentLayer("my-layer");
    setupLayer(layer);
  }
  ...
  public void testLocationAsConstant() {
    ...
    // Set and Get
    Float[] propertyValue = new Float[] {0f, 0f, 0f};
